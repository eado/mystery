DATA = b"""
PTHT/1.0 200 OK|Content-Type: text/plain||Let's keep this simple. 
...
for comments."""
ERR404 = b"""
PTHT/1.0 404 Not Found|Content-Type: text/plain||Looks like you're 
searching in the wrong place!"""
ERR400 = b"""
PTHT/1.0 400 Bad Request|Content-Type: text/plain||Sorry, I've got 
no idea what you're trying to tell me."""

PANY = "^DOWNLOAD( | $|$)[/A-Za-z0-9\\-\\._~!\\$&'\\(\\)\\*\\+,;=:@%]*\\s*(\\s+PTHT|\\s+PTHT/1.0)?\\s*$"
PEXACT = "^DOWNLOAD( | $|$)/*\\s*(\\s+PTHT|\\s+PTHT/1.0)?\\s*$"
